  ...
  return (
    <div className="relative overflow-hidden rounded-xl border border-slate-700 bg-gradient-to-b from-slate-900 to-slate-950 p-4 text-slate-100 shadow-lg">
      <div className="mb-3 flex items-center justify-between">
        ...
        <span className="text-[10px] font-medium text-violet-300">Powered by Gemini 2.5 Flash</span>
      </div>
      <div
        className="sentinel-md max-h-[320px] overflow-y-auto pr-1 text-sm leading-relaxed text-slate-200 [&_h2]:mb-2 [&_h2]:mt-4 [&_h2]:text-base [&_h2]:font-semibold [&_h2]:text-white [&_li]:ml-4 [&_li]:list-disc [&_p]:mb-2 [&_ul]:mb-2"
      >
        {narrative ? (
